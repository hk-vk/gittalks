        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
            ...
            <div className="p-5 sm:p-6 bg-[#111] border border-[#1a1a1a] rounded-xl sm:rounded-2xl sm:col-span-2 md:col-span-1">
              ...
              <h3 className="text-base sm:text-lg font-semibold mb-1 sm:mb-2">Two-Host Conversation</h3>
              <p className="text-[#888] text-xs sm:text-sm">Engaging dialogue between two AI hosts discussing your code</p>
            </div>
          </div>
        </div>
      </section>
